...
<head>
    ...
    <style>
        ...
        .badge-holiday {
            ...
            padding: 7px 14px;
            font-size: 15px;
            background: linear-gradient(92deg, #ffe7f9 0%, #e1f7fe 100%);
            color: #b3056b;
            font-weight: 600;
            transition: all .2s cubic-bezier(.44,2,.29,.75);
            box-shadow: 0 3px 10px 0 rgba(185,54,122,0.06);
        }
        .badge-holiday:hover {
            background: linear-gradient(90deg, #fceabb 0%, #f8bfff 100%);
            color: #ae0989;
            transform: translateY(-2px) scale(1.07);
            box-shadow: 0 6px 20px 0 rgba(130, 40, 200, 0.12);
            cursor: pointer;
        }
        .filter-form {
            background: #f6f8fa;
...
<div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="page-wrapper">
        <div class="container-fluid">
            ...
            <h3 class="mb-4 text-primary fw-bold fs-3 d-flex align-items-center justify-content-between flex-wrap gap-2">
                <span>🎉 Danh sách ngày nghỉ lễ</span>
                <div>
                    <button class="btn btn-success fw-bold ms-2" data-bs-toggle="modal" data-bs-target="#addHolidayModal">
                        ➕ Thêm ngày nghỉ lễ
                    </button>
                    <button class="btn btn-outline-primary fw-bold ms-2" data-bs-toggle="modal" data-bs-target="#importHolidayModal">
                        📥 Import Excel
                    </button>
                </div>
            </h3>
    ...
    <div class="modal fade" id="importHolidayModal" tabindex="-1" aria-labelledby="importHolidayModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="post" action="${pageContext.request.contextPath}/admin/holiday-dates" enctype="multipart/form-data" class="modal-content">
                <input type="hidden" name="action" value="import"/>
                <div class="modal-header">
                    <h5 class="modal-title" id="importHolidayModalLabel">Import ngày nghỉ lễ từ Excel</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Đóng"></button>
                </div>
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <small class="text-muted">File cần có các cột: <b>Tên ngày nghỉ lễ</b>, <b>Ngày nghỉ lễ</b> (yyyy-MM-dd), <b>Năm</b></small>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Hủy</button>
