...
<html lang="vi">
                                                        ...
                                                        <td>
                                                            ...
                                                            <td>
                                                                <button class="btn btn-sm btn-primary btn-update" 
                                                                        ...
                                                                        data-manager-comment="${dispute.managerComment != null ? dispute.managerComment : ''}"
                                                                        data-history="${dispute.history != null ? dispute.history : ''}">
                                                                    Cập nhật trạng thái
                                                                </button>
                                                            </td>
                                                        </tr>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius: 12px; box-shadow: 0 4px 16px rgba(0, 0, 0, 0.1); background: #fff;">
            <div class="modal-header" style="background: #f8f9fa; border-bottom: 1px solid #e9ecef; padding: 16px 24px;">
                <h5 class="modal-title" id="updateModalLabel" style="font-weight: 600; color: #1a73e8; font-size: 1.25rem;">Cập nhật trạng thái khiếu nại</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
                            <form action="${pageContext.request.contextPath}/manager/dispute-list" method="post" id="updateDisputeForm">

            <div class="modal-body" style="padding: 24px;">
                    <input type="hidden" id="disputeId" name="disputeId">
                    <div class="mb-3">
                        <label for="status" class="form-label" style="font-weight: 500; color: #495057; font-size: 14px;">Trạng thái</label>
                        <select class="form-select" id="status" name="status" required style="border-radius: 8px; padding: 10px; font-size: 14px; border: 1px solid #ced4da;">
                    ...
                    <div class="mb-3">
                        <label for="managerComment" class="form-label" style="font-weight: 500; color: #495057; font-size: 14px;">Bình luận quản lý</label>
                        <textarea class="form-control" id="managerComment" name="managerComment" rows="4" style="border-radius: 8px; padding: 10px; font-size: 14px; border: 1px solid #ced4da;"></textarea>
                    </div>
            </div>
            <div class="modal-footer" style="border-top: 1px solid #e9ecef; padding: 16px 24px;">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" style="border-radius: 8px; padding: 8px 20px; font-size: 14px;">Hủy</button>
                <button type="submit" class="btn btn-primary" id="saveChanges" style="border-radius: 8px; padding: 8px 20px; font-size: 14px; background-color: #1a73e8; border: none;">Lưu thay đổi</button>
            </div>
                                    </form>
                        ...
                        <script>
                            $(document).ready(function () {
                                // Khi nút "Cập nhật trạng thái" được nhấn
                                $('.btn-update').on('click', function () {
                                    const disputeId = $(this).data('dispute-id');
                                    const status = $(this).data('status');
                                    const managerComment = $(this).data('manager-comment');
